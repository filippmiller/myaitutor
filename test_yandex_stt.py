...
def test_stt():
    ...
    def gen():
        ...
        # Try RAW PCM instead of WAV container, maybe container parsing is failing
        # But we have a WAV file.
        
        # Let's try simpler options
        yield stt_service_pb2.StreamingRequest(
            session_options=stt_pb2.StreamingOptions(
                recognition_model=stt_pb2.RecognitionModelOptions(
                    ...
                    # Remove language restriction to default
